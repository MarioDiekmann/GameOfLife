  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData(prevState => ({
        ...prevState,
        User: decoded.userId// Replace this with the actual value you want to set for User
      }));
      

      const response = await axios.get(`http://localhost:5000/api/displayPattern/${formData.Name}`, formData);
