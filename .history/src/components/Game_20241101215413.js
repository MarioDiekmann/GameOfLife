    ...
    return (
        <div style={{ display: 'flex', height: '100vh' }}>
            ...
            <div style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <button className="button" onClick={makeFormVisible}>Save Pattern</button>
                <button className="button" onClick={makeRequestVisible}>Retrieve Pattern</button>
                ...
                {patternRequested && (
                    <div className="popup-overlay">
                        <div className="popup-content">
                            <LoadPatternForm onSubmit={closeForm} />
                        </div>
                    </div>
                )}
