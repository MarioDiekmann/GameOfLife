    ...
    <div className="content">
      ...
      <main className="text-content">
        ...
        <section>
          <h2>Breeder</h2>
          <p>
            A breeder is a larger structure that contains guns which in turn emit gliders or other components. It creates exponential growth and demonstrates how complexity can arise from simple rules. One well-known breeder is the "rake" that emits glider guns.
          </p>
        ...
        <section>
          ...
          <p>
            A "still life" is a stable pattern that does not change over time. The Block is the simplest example. Such patterns represent equilibrium states that emerge naturally in the simulation.
          </p>
