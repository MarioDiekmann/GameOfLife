    ...
    <div className="content">
      ...
      <main className="text-content">
        ...
        <section>
          ...
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/1/12/Game_of_life_animated_LWSS.gif"
            alt="LWSS animation"
          />
        </section>
        ...
        <section>
          ...
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/f/f0/Gospers_glider_gun.gif"
        ...
        <section>
          ...
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/0/0e/Conways_game_of_life_breeder_animation.gif"
